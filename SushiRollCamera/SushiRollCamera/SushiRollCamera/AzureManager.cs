...
namespace SushiRollCamera
{
    public class AzureManager
    {
        ...
        public async Task UpdateSushiRollInformation(NotSushiRollModel notHotDogModel)
        {
            await this.notSushiRollTable.UpdateAsync(notHotDogModel);
        }

        public async Task DeleteSushiRollInformation(NotSushiRollModel notSushiRollModel)
        {
            await this.notSushiRollTable.DeleteAsync(notSushiRollModel);
        }
    }
}
